...
// {multiset,multimap}.
            ...
            TEST(Btree, DefaultTransparent) {
...

                {
                    ...
                    EXPECT_EQ(s.begin(), s.find(abel::string_view("A")));
                    EXPECT_TRUE(s.contains(abel::string_view("A")));
                }
            }
...
// use non-default constructible comparators.
            struct SubstringLess {
                ...
                bool operator()(const std::string &a, const std::string &b) const {
                    return abel::string_view(a).substr(0, n) <
                           abel::string_view(b).substr(0, n);
                }
            ...
            TEST(Btree, KeyCompareToAdapter) {
                ...
                AssertKeyCompareToAdapted<std::less<abel::string_view>, abel::string_view>();
                AssertKeyCompareToAdapted<std::greater<abel::string_view>,
                        abel::string_view>();
