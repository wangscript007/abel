...
// This test is a no-op when abel::optional is an alias for std::optional and
// when exceptions are not enabled.
#if !defined(ABEL_USES_STD_OPTIONAL) && defined(ABEL_HAVE_EXCEPTIONS)
...
namespace abel {
    ...
    namespace {
        ...
        using Optional = abel::optional<Thrower>;

        using MoveThrower = testing::ThrowingValue<testing::TypeSpec::kNoThrowMove>;
        using MoveOptional = abel::optional<MoveThrower>;
        ...
        } catch (const abel::bad_optional_access &) {
            return true;
        }
        ...
        TEST(OptionalExceptionSafety, ThrowingConstructors) {
            ...
            auto integer_nonempty = abel::optional<int>(kInitialInteger);
            ...
            testing::TestThrowingCtor<abel::optional<ThrowerVec>>(
                    abel::in_place,
        ...
        TEST(OptionalExceptionSafety, EverythingThrowsSwap) {
            ...
            auto swap_nonempty = [](Optional *optional_ptr) {
                auto nonempty =
                        Optional(abel::in_place, kUpdatedInteger, testing::nothrow_ctor);
