#ifndef ABEL_ASL_ALGO_CONTAINER_H_
#define ABEL_ASL_ALGO_CONTAINER_H_
...
//------------------------------------------------------------------------------
// algorithm.h functions
//------------------------------------------------------------------------------

// c_linear_search()
//
// Container-based version of abel::linear_search() for performing a linear
...
// the first element in the container.
    ...
    Iterator c_rotate(C &sequence, Iterator middle) {
        return abel::rotate(container_algorithm_internal::c_begin(sequence), middle,
                            container_algorithm_internal::c_end(sequence));
    }
...
// abel::decay_t<T>. As a user of this function you can casually read
...
#endif  // ABEL_ASL_ALGO_CONTAINER_H_
