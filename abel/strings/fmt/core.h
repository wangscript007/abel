...
template <typename Char> using abel_string_view = abel::basic_string_view<Char>;
...
template <typename Char> class basic_string_view {
 ...
 public:
  ...
  template <typename S, FMT_ENABLE_IF(std::is_same<
                                      S, detail::abel_string_view<Char>>::value)>
...
template <typename Char,
          FMT_ENABLE_IF(!std::is_empty<detail::abel_string_view<Char>>::value)>
inline basic_string_view<Char> to_string_view(detail::abel_string_view<Char> s) {
  return s;
}
...
template <typename Context> struct arg_mapper {
  ...
  template <
      typename T,
      FMT_ENABLE_IF(
          std::is_constructible<abel_string_view<char_type>, T>::value &&
          !std::is_constructible<basic_string_view<char_type>, T>::value &&
          !is_string<T>::value && !has_formatter<T, Context>::value &&
          !has_fallback_formatter<T, Context>::value)>
  FMT_CONSTEXPR basic_string_view<char_type> map(const T& val) {
    return abel_string_view<char_type>(val);
  }
  ...
  template <typename T> struct need_copy {
    ...
    enum {
      value = !(detail::is_reference_wrapper<T>::value ||
                ...
                std::is_same<T, detail::abel_string_view<char_type>>::value ||
