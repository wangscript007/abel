...
// the convertible_to_string_view instance.
        ...
        public:
            ...
            abel::string_view value() const { return value_; }
...
// This class is NOT part of the public splitting API.
        ...
        public:
            ...
            split_iterator(State state, const Splitter *splitter)
                ...
                // empty abel::string_view whose .data() happens to be nullptr behaves
                // *differently* from an otherwise empty abel::string_view whose .data() is
                // not nullptr. This is an undesirable difference in general, but this
                // behavior is maintained to avoid breaking existing code that happens to
                // depend on this old behavior/bug. Perhaps it will be fixed one day. The
                // difference in behavior is as follows:
                //   Split(abel::string_view(""), '-');  // {""}
                //   Split(abel::string_view(), '-');    // {}
...
// and returns bool.
        ...
        public:
            ...
            abel::string_view text() const { return text_.value(); }

            const Delimiter &delimiter() const { return delimiter_; }

            const Predicate &predicate() const { return predicate_; }

            // Range functions that iterate the split substrings as abel::string_view
        ...
        private:
            ...
            // Partial specialization for a std::vector<abel::string_view>.
            //
            ...
            struct convert_to_container<std::vector<abel::string_view, A>,
                ...
                std::vector<abel::string_view, A> operator()(
                    ...
                    struct raw_view {
                        ...
                        operator abel::string_view() const {  // NOLINT(runtime/explicit)
                            return {data, size};
                        }
                    };
                    std::vector<abel::string_view, A> v;
            ...
            // In this case we first split the results to a std::vector<abel::string_view>
