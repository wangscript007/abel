...
#ifndef ABEL_STRINGS_INTERNAL_STR_JOIN_INTERNAL_H_
#define ABEL_STRINGS_INTERNAL_STR_JOIN_INTERNAL_H_
...
// 'second' member is formatted using f2_. sep_ is the separator.
        ...
        public:
            pair_formatter_impl(F1 f1, abel::string_view sep, F2 f2)
...
// specializations for other types.
        ...
        template<>
        struct default_formatter<abel::string_view> {
            typedef no_formatter Type;
        };
        template<typename ValueType>
...
// and formats each element using the provided Formatter object.
        ...
        std::string join_algorithm(Iterator start, Iterator end, abel::string_view s,
                                   Formatter &&f) {
            std::string result;
...
// range of string-like objects (e.g., std::string, abel::string_view), and an
...
// matches the end-of-tuple, and terminates the iteration.
        ...
        struct join_tuple_loop {
            ...
            void operator()(std::string *out, const Tup &tup, abel::string_view sep,
                            Formatter &&fmt) {
        ...
        struct join_tuple_loop<N, N> {
            template<typename Tup, typename Formatter>
            void operator()(std::string *, const Tup &, abel::string_view, Formatter &&) {}
        };

        template<typename... T, typename Formatter>
        std::string join_algorithm(const std::tuple<T...> &tup, abel::string_view sep,
                                   Formatter &&fmt) {
            std::string result;
        ...
        std::string join_range(const Range &range, abel::string_view separator,
                               Formatter &&fmt) {
            using std::begin;
            using std::end;
