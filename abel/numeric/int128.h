#ifndef ABEL_NUMERIC_INT128_H_
#define ABEL_NUMERIC_INT128_H_
...
#define ABEL_INTERNAL_WCHAR_T __wchar_t
#if defined(_M_X64)
#include <intrin.h>
#pragma intrinsic(_umul128)
#endif  // defined(_M_X64)
#else   // defined(_MSC_VER)
#define ABEL_INTERNAL_WCHAR_T wchar_t
...
namespace abel {
    ...
    // the `ABEL_HAVE_INTRINSIC_INT128` macro.)
    //
    ...
    // Example:
    //
    //     float y = abel::Uint128Max();  // Error. uint128 cannot be implicitly
    //                                    // converted to float.
    //
    //     abel::uint128 v;
    //     uint64_t i = v;                         // Error
...
// Example:
//
//     float y = abel::int128(17);  // Error. int128 cannot be implicitly
//                                  // converted to float.
//
//     abel::int128 v;
//     int64_t i = v;                        // Error
...
//
    ...
    public:
        ...
        // Example:
        //
        //   abel::int128 big = abel::make_int128(1, 0);
        //   abel::int128 big_n = abel::make_int128(-1, 0);
...
namespace std {
    ...
    public:
        ...
        static constexpr abel::int128 (min)() { return abel::int128_min(); }

        static constexpr abel::int128 lowest() { return abel::int128_min(); }

        static constexpr abel::int128 (max)() { return abel::int128_max(); }
...
#include <abel/numeric/int128_have_intrinsic.h>  // IWYU pragma: export
