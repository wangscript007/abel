...
//
// `abel::uniform_int_distribution` is a drop-in replacement for the C++11
// `std::uniform_int_distribution` [rand.dist.uni.int] but is considerably
// faster than the libstdc++ implementation.

#ifndef ABEL_RANDOM_UNIFORM_INT_DISTRIBUTION_H_
#define ABEL_RANDOM_UNIFORM_INT_DISTRIBUTION_H_
    ...
    public:
        ...
        private:
            ...
            static_assert(std::is_integral<result_type>::value,
                          "Class-template abel::uniform_int_distribution<> must be "
