...
#ifndef ABEL_RANDOM_GAUSSIAN_DISTRIBUTION_H_
#define ABEL_RANDOM_GAUSSIAN_DISTRIBUTION_H_

// abel::gaussian_distribution implements the Ziggurat algorithm
...
// Jurgen A Doornik.  (https://www.doornik.com/research/ziggurat.pdf)
        ...
        public:
            ...
            ABEL_FORCE_INLINE double zignor(URBG &g);  // NOLINT(runtime/references)

        private:
            friend class TableGenerator;

            template<typename URBG>
            ABEL_FORCE_INLINE double zignor_fallback(URBG &g,  // NOLINT(runtime/references)
                                                     bool neg);
    ...
    public:
        ...
        private:
            ...
            static_assert(
                    ...
                    "Class-template abel::gaussian_distribution<> must be parameterized "
