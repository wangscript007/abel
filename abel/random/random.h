...
#include <abel/random/distributions.h>  // IWYU pragma: export
#include <abel/random/engine/nonsecure_base.h>  // IWYU pragma: export
#include <abel/random/engine/pcg_engine.h>  // IWYU pragma: export
...
// ---------------------------------------------------------------------------
    ...
    using bit_gen = random_internal::nonsecure_urgb_base<
...
// often fast enough for the vast majority of applications.
    ...
    random_internal::nonsecure_urgb_base<random_internal::pcg64_2018_engine>;
