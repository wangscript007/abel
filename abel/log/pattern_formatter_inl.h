...
// pattern: [%Y-%m-%d %H:%M:%S.%e] [%n] [%l] %v
    ...
    ABEL_FORCE_INLINE pattern_formatter::pattern_formatter(
...
// use by default full formatter for if pattern is not given
    ABEL_FORCE_INLINE pattern_formatter::pattern_formatter(pattern_time_type time_type, std::string eol)
            : pattern_("%+"), eol_(std::move(eol)), pattern_time_type_(time_type), last_log_secs_(0) {
        std::memset(&cached_tm_, 0, sizeof(cached_tm_));
        formatters_.push_back(abel::make_unique<details::full_formatter>(details::padding_info{}));
    }

    ABEL_FORCE_INLINE std::unique_ptr<formatter> pattern_formatter::clone() const {
        custom_flags cloned_custom_formatters;
        for (auto &it : custom_handlers_) {
            cloned_custom_formatters[it.first] = it.second->clone();
        }
        return abel::make_unique<pattern_formatter>(pattern_, pattern_time_type_, eol_,
                                                       std::move(cloned_custom_formatters));
    }

    ABEL_FORCE_INLINE void pattern_formatter::format(const details::log_msg &msg, memory_buf_t &dest) {
    ...
    ABEL_FORCE_INLINE void pattern_formatter::set_pattern(std::string pattern) {
        pattern_ = std::move(pattern);
        compile_pattern_(pattern_);
    }

    ABEL_FORCE_INLINE std::tm pattern_formatter::get_time_(const details::log_msg &msg) {
    ...
    ABEL_FORCE_INLINE void pattern_formatter::handle_flag_(char flag, details::padding_info padding) {
        ...
        switch (flag) {
            case ('+'): // default formatter
                formatters_.push_back(abel::make_unique<details::full_formatter>(padding));
                break;

            case 'n': // logger name
                formatters_.push_back(abel::make_unique<details::name_formatter<Padder>>(padding));
                break;

            case 'l': // level
                formatters_.push_back(abel::make_unique<details::level_formatter<Padder>>(padding));
                break;

            case 'L': // short level
                formatters_.push_back(abel::make_unique<details::short_level_formatter<Padder>>(padding));
                break;

            case ('t'): // thread id
                formatters_.push_back(abel::make_unique<details::t_formatter<Padder>>(padding));
                break;

            case ('v'): // the message text
                formatters_.push_back(abel::make_unique<details::v_formatter<Padder>>(padding));
                break;

            case ('a'): // weekday
                formatters_.push_back(abel::make_unique<details::a_formatter<Padder>>(padding));
                break;
            ...
            case ('b'):
            case ('h'): // month
                formatters_.push_back(abel::make_unique<details::b_formatter<Padder>>(padding));
                break;
            ...
            case ('c'): // datetime
                formatters_.push_back(abel::make_unique<details::c_formatter<Padder>>(padding));
                break;
            ...
            case ('Y'): // year 4 digits
                formatters_.push_back(abel::make_unique<details::Y_formatter<Padder>>(padding));
                break;

            case ('D'):
            case ('x'): // datetime MM/DD/YY
                formatters_.push_back(abel::make_unique<details::D_formatter<Padder>>(padding));
                break;

            case ('m'): // month 1-12
                formatters_.push_back(abel::make_unique<details::m_formatter<Padder>>(padding));
                break;
            ...
            case ('H'): // hours 24
                formatters_.push_back(abel::make_unique<details::H_formatter<Padder>>(padding));
                break;

            case ('I'): // hours 12
                formatters_.push_back(abel::make_unique<details::I_formatter<Padder>>(padding));
                break;
            ...
            case ('S'): // seconds
                formatters_.push_back(abel::make_unique<details::S_formatter<Padder>>(padding));
                break;

            case ('e'): // milliseconds
                formatters_.push_back(abel::make_unique<details::e_formatter<Padder>>(padding));
                break;

            case ('f'): // microseconds
                formatters_.push_back(abel::make_unique<details::f_formatter<Padder>>(padding));
                break;
            ...
            case ('p'): // am/pm
                formatters_.push_back(abel::make_unique<details::p_formatter<Padder>>(padding));
                break;

            case ('r'): // 12 hour clock 02:55:02 pm
                formatters_.push_back(abel::make_unique<details::r_formatter<Padder>>(padding));
                break;
            ...
            case ('z'): // timezone
                formatters_.push_back(abel::make_unique<details::z_formatter<Padder>>(padding));
                break;

            case ('P'): // pid
                formatters_.push_back(abel::make_unique<details::pid_formatter<Padder>>(padding));
                break;

            case ('^'): // color range start
                formatters_.push_back(abel::make_unique<details::color_start_formatter>(padding));
                break;

            case ('$'): // color range end
                formatters_.push_back(abel::make_unique<details::color_stop_formatter>(padding));
                break;

            case ('@'): // source location (filename:filenumber)
                formatters_.push_back(abel::make_unique<details::source_location_formatter<Padder>>(padding));
                break;

            case ('s'): // short source filename - without directory name
                formatters_.push_back(abel::make_unique<details::short_filename_formatter<Padder>>(padding));
                break;

            case ('g'): // full source filename
                formatters_.push_back(abel::make_unique<details::source_filename_formatter<Padder>>(padding));
                break;

            case ('#'): // source line number
                formatters_.push_back(abel::make_unique<details::source_linenum_formatter<Padder>>(padding));
                break;

            case ('!'): // source funcname
                formatters_.push_back(abel::make_unique<details::source_funcname_formatter<Padder>>(padding));
                break;

            case ('%'): // % char
                formatters_.push_back(abel::make_unique<details::ch_formatter>('%'));
                break;

            case ('u'): // elapsed time since last log message in nanos
                formatters_.push_back(
                        abel::make_unique<details::elapsed_formatter<Padder, std::chrono::nanoseconds>>(padding));
                break;

            case ('i'): // elapsed time since last log message in micros
                formatters_.push_back(
                        abel::make_unique<details::elapsed_formatter<Padder, std::chrono::microseconds>>(padding));
                break;

            case ('o'): // elapsed time since last log message in millis
                formatters_.push_back(
                        abel::make_unique<details::elapsed_formatter<Padder, std::chrono::milliseconds>>(padding));
                break;

            case ('O'): // elapsed time since last log message in seconds
                formatters_.push_back(
                        abel::make_unique<details::elapsed_formatter<Padder, std::chrono::seconds>>(padding));
                break;

            default: // Unknown flag appears as is
                auto unknown_flag = abel::make_unique<details::aggregate_formatter>();
                unknown_flag->add_ch('%');
...
// Return padding.
    ABEL_FORCE_INLINE details::padding_info
    ...
    ABEL_FORCE_INLINE void pattern_formatter::compile_pattern_(const std::string &pattern) {
        ...
        for (auto it = pattern.begin(); it != end; ++it) {
            ...
            {
                if (!user_chars) {
                    user_chars = abel::make_unique<details::aggregate_formatter>();
                }
