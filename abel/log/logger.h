...
namespace abel {
    ...
    public:
        ...
        template<class T, typename std::enable_if<
                std::is_convertible<const T &, abel::string_view_t>::value &&
                !fmt::is_compile_string<T>::value, int>::type = 0>
        ...
        template<class T, typename std::enable_if<!std::is_convertible<const T &, abel::string_view_t>::value &&
