...
template<typename Mutex>
ABEL_FORCE_INLINE abel::sinks::base_sink<Mutex>::base_sink(std::unique_ptr<abel::formatter> formatter)
...
template<typename Mutex>
void ABEL_FORCE_INLINE abel::sinks::base_sink<Mutex>::set_formatter(std::unique_ptr<abel::formatter> sink_formatter) {
    std::lock_guard<Mutex> lock(mutex_);
...
template<typename Mutex>
void ABEL_FORCE_INLINE abel::sinks::base_sink<Mutex>::set_formatter_(std::unique_ptr<abel::formatter> sink_formatter) {
