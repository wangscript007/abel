...
// initialize entities used by the scheduler implementation.
        template<typename Callable, typename... Args>
        void low_level_call_once(abel::once_flag *flag, Callable &&fn, Args &&... args);
...
// once_flag will be valid for immediate use.
        ...
        template<typename Callable, typename... Args>
        ABEL_NO_INLINE
        void call_once_impl(std::atomic<uint32_t> *control,
        ...
        void low_level_call_once(abel::once_flag *flag, Callable &&fn, Args &&... args) {
            ...
            if (ABEL_UNLIKELY(s != base_internal::kOnceDone)) {
                base_internal::call_once_impl(once, thread_internal::SCHEDULE_KERNEL_ONLY,
