...
#ifndef ABEL_ASL_BTREE_MAP_H_
#define ABEL_ASL_BTREE_MAP_H_
...
// abel::btree_map<>
//
// An `abel::btree_map<K, V>` is an ordered associative container of
...
// `std::less<K>`.
//
// An `abel::btree_map<K, V>` uses a default allocator of
// `std::allocator<std::pair<const K, V>>` to allocate (and deallocate)
// nodes, and construct and destruct values within those nodes. You may
// instead specify a custom allocator `A` (which in turn requires specifying a
// custom comparator `C`) as in `abel::btree_map<K, V, C, A>`.
//
    ...
    public:
        ...
        // * Default constructor
        //
        //   abel::btree_map<int, std::string> map1;
        //
        // * Initializer List constructor
        //
        //   abel::btree_map<int, std::string> map2 =
        //       {{1, "huey"}, {2, "dewey"}, {3, "louie"},};
        //
        // * Copy constructor
        //
        //   abel::btree_map<int, std::string> map3(map2);
        //
        // * Copy assignment operator
        //
        //  abel::btree_map<int, std::string> map4;
        //  map4 = map3;
        //
        // * Move constructor
        //
        //   // Move is guaranteed efficient
        //   abel::btree_map<int, std::string> map5(std::move(map4));
        //
        // * Move assignment operator
        //
        //   // May be efficient if allocators are compatible
        //   abel::btree_map<int, std::string> map6;
        //   map6 = std::move(map5);
        //
        // * Range constructor
        //
        //   std::vector<std::pair<int, std::string>> v = {{1, "a"}, {2, "b"}};
        //   abel::btree_map<int, std::string> map7(v.begin(), v.end());
        btree_map() {}
...
// abel::swap(abel::btree_map<>, abel::btree_map<>)
//
// Swaps the contents of two `abel::btree_map` containers.
    template<typename K, typename V, typename C, typename A>
    void swap(btree_map<K, V, C, A> &x, btree_map<K, V, C, A> &y) {
        return x.swap(y);
    }

// abel::erase_if(abel::btree_map<>, Pred)
//
...
// abel::btree_multimap
//
// An `abel::btree_multimap<K, V>` is an ordered associative container of
// keys and associated values designed to be a more efficient replacement for
// `std::multimap` (in most cases). Unlike `abel::btree_map`, a B-tree multimap
// allows multiple elements with equivalent keys.
//
// Keys are sorted using an (optional) comparison function, which defaults to
// `std::less<K>`.
//
// An `abel::btree_multimap<K, V>` uses a default allocator of
// `std::allocator<std::pair<const K, V>>` to allocate (and deallocate)
// nodes, and construct and destruct values within those nodes. You may
// instead specify a custom allocator `A` (which in turn requires specifying a
// custom comparator `C`) as in `abel::btree_multimap<K, V, C, A>`.
//
    template<typename Key, typename Value, typename Compare = std::less<Key>,
            typename Alloc = std::allocator<std::pair<const Key, Value>>>
    ...
    public:
        ...
        // * Default constructor
        //
        //   abel::btree_multimap<int, std::string> map1;
        //
        // * Initializer List constructor
        //
        //   abel::btree_multimap<int, std::string> map2 =
        //       {{1, "huey"}, {2, "dewey"}, {3, "louie"},};
        //
        // * Copy constructor
        //
        //   abel::btree_multimap<int, std::string> map3(map2);
        //
        // * Copy assignment operator
        //
        //  abel::btree_multimap<int, std::string> map4;
        //  map4 = map3;
        //
        // * Move constructor
        //
        //   // Move is guaranteed efficient
        //   abel::btree_multimap<int, std::string> map5(std::move(map4));
        //
        // * Move assignment operator
        //
        //   // May be efficient if allocators are compatible
        //   abel::btree_multimap<int, std::string> map6;
        //   map6 = std::move(map5);
        //
        // * Range constructor
        //
        //   std::vector<std::pair<int, std::string>> v = {{1, "a"}, {2, "b"}};
        //   abel::btree_multimap<int, std::string> map7(v.begin(), v.end());
        btree_multimap() {}
...
// abel::swap(abel::btree_multimap<>, abel::btree_multimap<>)
//
// Swaps the contents of two `abel::btree_multimap` containers.
    template<typename K, typename V, typename C, typename A>
    void swap(btree_multimap<K, V, C, A> &x, btree_multimap<K, V, C, A> &y) {
        return x.swap(y);
    }

// abel::erase_if(abel::btree_multimap<>, Pred)
//
// Erases all elements that satisfy the predicate pred from the container.
    template<typename K, typename V, typename C, typename A, typename Pred>
