...
#ifndef ABEL_ASL_CONTAINER_BTREE_H_
#define ABEL_ASL_CONTAINER_BTREE_H_
...
// comparator.
        ...
        struct StringBtreeDefaultLess {
            ...
            abel::weak_ordering operator()(abel::string_view lhs,
                                           abel::string_view rhs) const {
...
// default.
        ...
        template<>
        struct key_compare_to_adapter<std::less<abel::string_view>> {
            using type = StringBtreeDefaultLess;
        };

        template<>
        struct key_compare_to_adapter<std::greater<abel::string_view>> {
            using type = StringBtreeDefaultGreater;
        };
...
// that the children array is only valid in internal nodes.
        ...
        public:
            ...
            void clear_child(int i) {
                abel::container_internal::SanitizerPoisonObject(&mutable_child(i));
            }

            void set_child(int i, btree_node *c) {
                abel::container_internal::SanitizerUnpoisonObject(&mutable_child(i));
                mutable_child(i) = c;
                c->set_position(i);
            }
            ...
            static btree_node *init_leaf(btree_node *n, btree_node *parent,
                ...
                abel::container_internal::SanitizerPoisonMemoryRegion(
        ...
        private:
            ...
            void value_init(const size_type i, allocator_type *alloc, Args &&... args) {
                abel::container_internal::SanitizerUnpoisonObject(slot(i));
                params_type::construct(alloc, slot(i), std::forward<Args>(args)...);
            }

            void value_destroy(const size_type i, allocator_type *alloc) {
                params_type::destroy(alloc, slot(i));
                abel::container_internal::SanitizerPoisonObject(slot(i));
            }
        ...
        private:
            ...
            abel::container_internal::CompressedTuple<key_compare, allocator_type,
                    node_type *>
                    root_;
...
#endif  // ABEL_ASL_CONTAINER_BTREE_H_
