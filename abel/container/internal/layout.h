...
#ifndef ABEL_ASL_CONTAINER_LAYOUT_H_
#define ABEL_ASL_CONTAINER_LAYOUT_H_
...
#define ABEL_INTERNAL_HAS_CXA_DEMANGLE
#endif

#ifdef ABEL_INTERNAL_HAS_CXA_DEMANGLE
...
// Does `Ts...` contain `T`?
            ...
            using Contains = abel::disjunction<std::is_same<T, Ts>...>;
...
// Requires: `m` is a power of two. It's enforced by IsLegalElementType below.
                ...
                std::string TypeName() {
                    ...
                    if (status == 0 && demangled != nullptr) {  // Demangling succeeded.
                        abel::string_append(&out, "<", demangled, ">");
                        free(demangled);
                    } else {
#if defined(__GXX_RTTI) || defined(_CPPRTTI)
                        abel::string_append(&out, "<", typeid(T).name(), ">");
#endif
                    }
                    return out;
                }
...
// can compute offsets).
            ...
            class LayoutImpl<std::tuple<Elements...>, abel::index_sequence<SizeSeq...>,
                    abel::index_sequence<OffsetSeq...>> {
            private:
                static_assert(sizeof...(Elements) > 0, "At least one field is required");
                static_assert(abel::conjunction<IsLegalElementType<Elements>...>::value,
            ...
            public:
                ...
                std::string DebugString() const {
                    ...
                    if (NumTypes == NumSizes && last >= 0) {
                        abel::string_append(&res, "[", size_[last], "]");
                    }
                    return res;
                }
            ...
            using LayoutType = LayoutImpl<
                    std::tuple<Ts...>, abel::make_index_sequence<NumSizes>,
                    abel::make_index_sequence<adl_barrier::Min(sizeof...(Ts), NumSizes + 1)>>;
...
// by `Layout`.
        ...
        public:
            ...
            static_assert(
                    abel::conjunction<internal_layout::IsLegalElementType<Ts>...>::value,
                    "Invalid element type (see IsLegalElementType)");
            ...
            static constexpr PartialType<sizeof...(Sizes)> Partial(Sizes &&... sizes) {
                ...
                return PartialType<sizeof...(Sizes)>(abel::forward<Sizes>(sizes)...);
            }
...
#endif  // ABEL_ASL_CONTAINER_LAYOUT_H_
