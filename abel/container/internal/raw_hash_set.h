...
//
// The table stores elements ABEL_FORCE_INLINE in a slot array. In addition to the slot
...
#ifndef ABEL_ASL_CONTAINER_RAW_HASH_SET_H_
#define ABEL_ASL_CONTAINER_RAW_HASH_SET_H_
...
// This enables removing a branch in the hot path of find().
        ABEL_FORCE_INLINE ctrl_t *EmptyGroup() {
...
// non-determinism of iteration order in most cases.
        ABEL_FORCE_INLINE size_t HashSeed(const ctrl_t *ctrl) {
        ...
        ABEL_FORCE_INLINE size_t H1(size_t hash, const ctrl_t *ctrl) {
            return (hash >> 7) ^ HashSeed(ctrl);
        }

        ABEL_FORCE_INLINE ctrl_t H2(size_t hash) { return hash & 0x7F; }

        ABEL_FORCE_INLINE bool IsEmpty(ctrl_t c) { return c == kEmpty; }

        ABEL_FORCE_INLINE bool IsFull(ctrl_t c) { return c >= 0; }

        ABEL_FORCE_INLINE bool IsDeleted(ctrl_t c) { return c == kDeleted; }

        ABEL_FORCE_INLINE bool IsEmptyOrDeleted(ctrl_t c) { return c < kSentinel; }
...
// when using -funsigned-char under GCC.
        ABEL_FORCE_INLINE __m128i _mm_cmpgt_epi8_fixed(__m128i a, __m128i b) {
        ...
        ABEL_FORCE_INLINE bool IsValidCapacity(size_t n) { return ((n + 1) & n) == 0 && n > 0; }
...
//   EMPTY -> EMPTY
//   FULL -> DELETED
        ABEL_FORCE_INLINE void ConvertDeletedToEmptyAndFullToDeleted(
...
// For 16-wide groups, that gives an average of two empty slots per group.
        ABEL_FORCE_INLINE size_t CapacityToGrowth(size_t capacity) {
            assert(IsValidCapacity(capacity));
            // `capacity*7/8`
...
// Might not be a valid one and required NormalizeCapacity().
        ABEL_FORCE_INLINE size_t GrowthToLowerboundCapacity(size_t growth) {
            // `growth*8/7`
...
// constructed and destroyed.
        ...
        public:
            ...
            using pointer = typename abel::allocator_traits<
                    allocator_type>::template rebind_traits<value_type>::pointer;
            using const_pointer = typename abel::allocator_traits<
        ...
        private:
            ...
            using Layout = abel::container_internal::Layout<ctrl_t, slot_type>;
            ...
            using AllocTraits = abel::allocator_traits<allocator_type>;
            using SlotAlloc = typename abel::allocator_traits<
                    allocator_type>::template rebind_alloc<slot_type>;
            using SlotAllocTraits = typename abel::allocator_traits<
            ...
            using RequiresInsertable = typename std::enable_if<
                    abel::disjunction<std::is_convertible<T, init_type>,
        ...
        public:
            ...
            public:
                ...
                using reference =
                abel::conditional_t<PolicyTraits::constant_iterators::value,
                        const value_type &, value_type &>;
                using pointer = abel::remove_reference_t<reference> *;
            ...
            //   // copies the strings into the set.
            //   abel::flat_hash_set<std::string> s = {"abc", "def"};
            //
            ...
            std::is_nothrow_copy_constructible<allocator_type>::value)
                    : ctrl_(abel::exchange(that.ctrl_, EmptyGroup())),
                      slots_(abel::exchange(that.slots_, nullptr)),
                      size_(abel::exchange(that.size_, 0)),
                      capacity_(abel::exchange(that.capacity_, 0)),
                      infoz_(abel::exchange(that.infoz_, HashtablezInfoHandle())),
            ...
            abel::allocator_traits<allocator_type>::is_always_equal::value &&
        ...
        private:
            ...
            friend
            struct abel::container_internal::hashtable_debug_internal::
            ...
            void drop_deletes_without_resize() ABEL_NO_INLINE {
        ...
        private:
            ...
            abel::container_internal::CompressedTuple<size_t /* growth_left */, hasher,
...
// Erases all elements that satisfy the predicate `pred` from the container `c`.
        ...
        namespace hashtable_debug_internal {
            ...
            struct HashtableDebugAccess<Set, abel::void_t<typename Set::raw_hash_set>> {
...
#endif  // ABEL_ASL_CONTAINER_RAW_HASH_SET_H_
