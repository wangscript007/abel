...
//   char storage[64];
//   abel::bounded_queue<int> q(storage, sizeof(storage), abel::NOT_OWN_STORAGE);
//   q.push(1);
//   q.push(2);
//   ...
...
//   }
    ...
    public:
        ...
        bounded_queue(void *mem, size_t memsize, storage_ownership ownership)
    ...
    private:
        ...
        ABEL_NON_COPYABLE(bounded_queue);
