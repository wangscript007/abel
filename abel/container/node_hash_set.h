...
// -----------------------------------------------------------------------------
//
// An `abel::node_hash_set<T>` is an unordered associative container designed to
...
#ifndef ABEL_ASL_NODE_HASH_SET_H_
#define ABEL_ASL_NODE_HASH_SET_H_
...
// -----------------------------------------------------------------------------
//
// An `abel::node_hash_set<T>` is an unordered associative container which
...
//  }
    ...
    class node_hash_set
            : public abel::container_internal::raw_hash_set<
                    abel::container_internal::NodeHashSetPolicy<T>, Hash, Eq, Alloc> {
    ...
    public:
        ...
        //    abel::node_hash_set<std::string> set1;
        //
        // * Initializer List constructor
        //
        //   abel::node_hash_set<std::string> set2 =
        //       {{"huey"}, {"dewey"}, {"louie"},};
        //
        // * Copy constructor
        //
        //   abel::node_hash_set<std::string> set3(set2);
        //
        // * Copy assignment operator
        //
        //  // Hash functor and Comparator are copied as well
        //  abel::node_hash_set<std::string> set4;
        //  set4 = set3;
        //
        // * Move constructor
        //
        //   // Move is guaranteed efficient
        //   abel::node_hash_set<std::string> set5(std::move(set4));
        //
        // * Move assignment operator
        //
        //   // May be efficient if allocators are compatible
        //   abel::node_hash_set<std::string> set6;
        //   set6 = std::move(set5);
        //
        // * Range constructor
        //
        //   std::vector<std::string> v = {"a", "b"};
        //   abel::node_hash_set<std::string> set7(v.begin(), v.end());
        node_hash_set() {}
        ...
        //
        // NOTE: this member function is particular to `abel::node_hash_set` and is
...
// Erases all elements that satisfy the predicate `pred` from the container `c`.
    ...
    namespace container_internal {
        ...
        template<class T>
        struct NodeHashSetPolicy
                : abel::container_internal::node_hash_policy<T &, NodeHashSetPolicy<T>> {
            using key_type = T;
            using init_type = T;
            ...
            static T *new_element(Allocator *alloc, Args &&... args) {
                using ValueAlloc =
                typename abel::allocator_traits<Allocator>::template rebind_alloc<T>;
                ValueAlloc value_alloc(*alloc);
                T *res = abel::allocator_traits<ValueAlloc>::allocate(value_alloc, 1);
                abel::allocator_traits<ValueAlloc>::construct(value_alloc, res,
            ...
            static void delete_element(Allocator *alloc, T *elem) {
                ...
                typename abel::allocator_traits<Allocator>::template rebind_alloc<T>;
                ValueAlloc value_alloc(*alloc);
                abel::allocator_traits<ValueAlloc>::destroy(value_alloc, elem);
                abel::allocator_traits<ValueAlloc>::deallocate(value_alloc, elem, 1);
            }
...
// Specialization of trait in abel/algorithm/container.h
        ...
        struct IsUnorderedContainer<abel::node_hash_set<Key, Hash, KeyEqual, Allocator>>
                : std::true_type {
        };
...
#endif  // ABEL_ASL_NODE_HASH_SET_H_
