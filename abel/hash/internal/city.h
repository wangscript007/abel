...
namespace abel {
    ...
    namespace hash_internal {
        ...
        ABEL_FORCE_INLINE uint64_t uint128_low64(const uint128 &x) { return x.first; }

        ABEL_FORCE_INLINE uint64_t uint128_high64(const uint128 &x) { return x.second; }
...
// This is intended to be a reasonably good hash function.
        ABEL_FORCE_INLINE uint64_t hash128_to_64(const uint128 &x) {
