//
// Implementation details of abel/types/variant.h, pulled into a
// separate file to avoid cluttering the top of the API header with
// implementation details.

#ifndef ABEL_ASL_INTERNAL_VARIANT_H_
#define ABEL_ASL_INTERNAL_VARIANT_H_
...
#include <abel/utility/bad_variant_access.h>
...
// Convenience alias, since size_t integral_constant is used a lot in this file.
        ...
        struct VariantAccessResultImpl<I, Variantemplate<T...> &> {
            using type = typename abel::variant_alternative<I, variant<T...>>::type &;
        };

        template<std::size_t I, template<class...> class Variantemplate, class... T>
        struct VariantAccessResultImpl<I, const Variantemplate<T...> &> {
            using type =
            const typename abel::variant_alternative<I, variant<T...>>::type &;
        };
...
// Note: Intentionally is an alias.
        ...
        struct VisitIndicesResultImpl {
            using type = abel::result_of_t<Op(AlwaysZero<Vs>...)>;
        };
        ...
        constexpr ReturnType call_with_indices(FunctionObject &&function) {
            ...
            return abel::forward<FunctionObject>(function)(SizeT<Indices>()...);
        }
        ...
        struct MakeVisitationMatrix<ReturnType, FunctionObject,
                ...
                : MakeVisitationMatrixImpl<ReturnType, FunctionObject,
                        ...
                        abel::make_index_sequence<HeadEndIndex>,
                        index_sequence<BoundIndices...>> {
        };
        ...
        struct UnreachableSwitchCase {
            ...
            [[noreturn]] static VisitIndicesResultT<Op, std::size_t> Run(
                    Op && /*ignored*/) {
#if ABEL_COMPILER_HAS_BUILTIN(__builtin_unreachable) || \
    (defined(__GNUC__) && !defined(__clang__))
        ...
        struct ReachableSwitchCase {
            static VisitIndicesResultT<Op, std::size_t> Run(Op &&op) {
                return abel::base_internal::Invoke(abel::forward<Op>(op), SizeT<I>());
            }
        };
...
//       "free" whereas other template instantiations are costly).
        ...
        [[noreturn]] ReturnType TypedThrowBadVariantAccess() {
            abel::variant_internal::throw_bad_variant_access();
        }
...
// A switch statement optimizes better than the table of function pointers.
        ...
        struct VisitIndicesSwitch {
            ...
            static VisitIndicesResultT<Op, std::size_t> Run(Op &&op, std::size_t i) {
                switch (i) {
                    case 0:
                        return PickCase<Op, 0, EndIndex>::Run(abel::forward<Op>(op));
                    case 1:
                        return PickCase<Op, 1, EndIndex>::Run(abel::forward<Op>(op));
                    case 2:
                        return PickCase<Op, 2, EndIndex>::Run(abel::forward<Op>(op));
                    case 3:
                        return PickCase<Op, 3, EndIndex>::Run(abel::forward<Op>(op));
                    case 4:
                        return PickCase<Op, 4, EndIndex>::Run(abel::forward<Op>(op));
                    case 5:
                        return PickCase<Op, 5, EndIndex>::Run(abel::forward<Op>(op));
                    case 6:
                        return PickCase<Op, 6, EndIndex>::Run(abel::forward<Op>(op));
                    case 7:
                        return PickCase<Op, 7, EndIndex>::Run(abel::forward<Op>(op));
                    case 8:
                        return PickCase<Op, 8, EndIndex>::Run(abel::forward<Op>(op));
                    case 9:
                        return PickCase<Op, 9, EndIndex>::Run(abel::forward<Op>(op));
                    case 10:
                        return PickCase<Op, 10, EndIndex>::Run(abel::forward<Op>(op));
                    case 11:
                        return PickCase<Op, 11, EndIndex>::Run(abel::forward<Op>(op));
                    case 12:
                        return PickCase<Op, 12, EndIndex>::Run(abel::forward<Op>(op));
                    case 13:
                        return PickCase<Op, 13, EndIndex>::Run(abel::forward<Op>(op));
                    case 14:
                        return PickCase<Op, 14, EndIndex>::Run(abel::forward<Op>(op));
                    case 15:
                        return PickCase<Op, 15, EndIndex>::Run(abel::forward<Op>(op));
                    case 16:
                        return PickCase<Op, 16, EndIndex>::Run(abel::forward<Op>(op));
                    case 17:
                        return PickCase<Op, 17, EndIndex>::Run(abel::forward<Op>(op));
                    case 18:
                        return PickCase<Op, 18, EndIndex>::Run(abel::forward<Op>(op));
                    case 19:
                        return PickCase<Op, 19, EndIndex>::Run(abel::forward<Op>(op));
                    case 20:
                        return PickCase<Op, 20, EndIndex>::Run(abel::forward<Op>(op));
                    case 21:
                        return PickCase<Op, 21, EndIndex>::Run(abel::forward<Op>(op));
                    case 22:
                        return PickCase<Op, 22, EndIndex>::Run(abel::forward<Op>(op));
                    case 23:
                        return PickCase<Op, 23, EndIndex>::Run(abel::forward<Op>(op));
                    case 24:
                        return PickCase<Op, 24, EndIndex>::Run(abel::forward<Op>(op));
                    case 25:
                        return PickCase<Op, 25, EndIndex>::Run(abel::forward<Op>(op));
                    case 26:
                        return PickCase<Op, 26, EndIndex>::Run(abel::forward<Op>(op));
                    case 27:
                        return PickCase<Op, 27, EndIndex>::Run(abel::forward<Op>(op));
                    case 28:
                        return PickCase<Op, 28, EndIndex>::Run(abel::forward<Op>(op));
                    case 29:
                        return PickCase<Op, 29, EndIndex>::Run(abel::forward<Op>(op));
                    case 30:
                        return PickCase<Op, 30, EndIndex>::Run(abel::forward<Op>(op));
                    case 31:
                        return PickCase<Op, 31, EndIndex>::Run(abel::forward<Op>(op));
                    case 32:
                        return PickCase<Op, 32, EndIndex>::Run(abel::forward<Op>(op));
                    default:
                        ABEL_ASSERT(i == variant_npos);
                        return abel::base_internal::Invoke(abel::forward<Op>(op), NPos());
                }
            }
        };
...
// The backend for converting an N-ary visit operation into a unary visit.
        ...
        struct VisitIndicesVariadicImpl<abel::index_sequence<N...>, EndIndices...> {
            ...
            static VisitIndicesResultT<Op, decltype(EndIndices)...> Run(
                ...
                return VisitIndicesSwitch<NumCasesOfSwitch<EndIndices...>::value>::Run(
                        FlattenedOp<Op>{abel::forward<Op>(op)},
        ...
        struct VisitIndicesVariadic
                : VisitIndicesVariadicImpl<abel::make_index_sequence<sizeof...(EndIndices)>,
                        EndIndices...> {
        };
...
//   size.
        template<std::size_t... EndIndices>
        struct VisitIndices
                : abel::conditional_t<(NumCasesOfSwitch<EndIndices...>::value <=
        ...
        struct VisitIndices<EndIndex>
                : abel::conditional_t<(EndIndex <= MaxUnrolledVisitCases),
...
// NOTE: DO NOT REMOVE the `ABEL_FORCE_INLINE` keyword as it is necessary to work around a
// MSVC bug. 
        template<class Self, std::size_t I>
        ABEL_FORCE_INLINE VariantAccessResult<I, Self> AccessUnion(Self &&self, SizeT<I> /*i*/) {
...
// operations.
        struct VariantCoreAccess {
            ...
            static void InitFrom(Variant &self, Variant &&other) {  // NOLINT
                VisitIndices<abel::variant_size<Variant>::value>::Run(
            ...
            static VariantAccessResult<I, Variant> CheckedAccess(Variant &&self) {
                if (ABEL_UNLIKELY(self.index_ != I)) {
                    TypedThrowBadVariantAccess<VariantAccessResult<I, Variant>>();
                }

                return Access<I>(abel::forward<Variant>(self));
            }
            ...
            struct MoveAssignVisitor {
                ...
                void operator()(SizeT<abel::variant_npos> /*new_i*/) const {
                    Destroy(*left);
                }
            ...
            struct CopyAssignVisitor {
                ...
                void operator()(SizeT<NewIndex> /*new_i*/) const {
                    using New =
                    typename abel::variant_alternative<NewIndex, DerivedType>::type;
            ...
            struct ConversionAssignVisitor {
                ...
                void operator()(SizeT<NewIndex::value> /*old_i*/
                    ...
                    Access<NewIndex::value>(*left) = abel::forward<QualifiedNew>(other);
                }
                ...
                void operator()(SizeT<OldIndex> /*old_i*/
                    ...
                    using New =
                    typename abel::variant_alternative<NewIndex::value, Left>::type;
                    if (std::is_nothrow_constructible<New, QualifiedNew>::value ||
                        !std::is_nothrow_move_constructible<New>::value) {
                        left->template emplace<NewIndex::value>(
                                abel::forward<QualifiedNew>(other));
                    } else {
                        ...
                        left->template emplace<NewIndex::value>(
                                New(abel::forward<QualifiedNew>(other)));
                    }
                }
            ...
            MakeConversionAssignVisitor(Left *left, QualifiedNew &&qual) {
                return {left, abel::forward<QualifiedNew>(qual)};
            }
            ...
            static typename abel::variant_alternative<NewIndex, Self>::type &Replace(
                    Self *self, Args &&... args) {
                Destroy(*self);
                using New = typename abel::variant_alternative<NewIndex, Self>::type;
                New *const result = ::new(static_cast<void *>(&self->state_))
                        New(abel::forward<Args>(args)...);
...
// constraints.
        ...
        struct ContainsVariantNPos
                : abel::negation<std::is_same<  // NOLINT
                        abel::integer_sequence<bool, 0 <= Is...>,
                        abel::integer_sequence<bool, Is != abel::variant_npos...>>> {
        };

        template<class Op, class... QualifiedVariants>
        using RawVisitResult =
        abel::result_of_t<Op(VariantAccessResult<0, QualifiedVariants>...)>;
        ...
        struct PerformVisitation {
            ...
            constexpr ReturnType operator()(SizeT<Is>... indices) const {
                return Run(typename ContainsVariantNPos<Is...>::type{},
                           abel::index_sequence_for<QualifiedVariants...>(), indices...);
            }
            ...
            constexpr ReturnType Run(std::false_type /*has_valueless*/,
                ...
                static_assert(
                        std::is_same<ReturnType,
                                abel::result_of_t<Op(VariantAccessResult<
                                        Is, QualifiedVariants>...)>>::value,
                        "All visitation overloads must have the same return type.");
                return abel::base_internal::Invoke(
                        abel::forward<Op>(op),
                        VariantCoreAccess::Access<Is>(
                                abel::forward<QualifiedVariants>(std::get<TupIs>(variant_tup)))...);
            }
...
#pragma warning(disable : 4624)
        ...
        union Union<Head, Tail...> {
            ...
            explicit constexpr Union(EmplaceTag<0>, P &&... args)
                    : head(abel::forward<P>(args)...) {}

            template<std::size_t I, class... P>
            explicit constexpr Union(EmplaceTag<I>, P &&... args)
                    : tail(EmplaceTag<I - 1>{}, abel::forward<P>(args)...) {}
...
// this resultant type.
        ...
        abel::conditional_t<std::is_destructible<Union<T...>>::value, Union<T...>,
...
// Deepest base, containing the actual union and the discriminator
        ...
        protected:
            ...
            template<class LazyH = H,
                    class ConstructibleH = abel::enable_if_t<
            ...
            explicit constexpr VariantStateBase(EmplaceTag<I> tag, P &&... args)
                    : state_(tag, abel::forward<P>(args)...), index_(I) {}
...
// contexts.
        ...
        using RequireAllHaveEqualT = abel::enable_if_t<
                abel::conjunction<is_detected_convertible<bool, EqualResult, T>...>::value,
                bool>;

        template<class... T>
        using RequireAllHaveNotEqualT =
        abel::enable_if_t<abel::conjunction<is_detected_convertible<
...
// single template parameter.
        ...
        struct VariantHelper<variant<Ts...>> {
            ...
            struct CanConvertFrom<variant<Us...>>
                    : public abel::conjunction<CanAccept<Us>...> {
            };
        };
...
// Base that is dependent on whether or not the destructor can be trivial.
        ...
        abel::conditional_t<std::is_destructible<Union<T...>>::value,
                VariantStateBase<T...>,
...
// work around the bug.
        template<class... T>
        using VariantMoveBase = abel::conditional_t<
                abel::disjunction<
                        abel::negation<abel::conjunction<std::is_move_constructible<T>...>>,
                        abel::conjunction<IsTriviallyMoveConstructible<T>...>>::value,
...
// Base that is dependent on whether or not the copy-constructor can be trivial.
        template<class... T>
        using VariantCopyBase = abel::conditional_t<
                abel::disjunction<
                        abel::negation<abel::conjunction<std::is_copy_constructible<T>...>>,
                        std::is_copy_constructible<Union<T...>>>::value,
                VariantMoveBase<T...>, VariantCopyBaseNontrivial<T...>>;

// Base that is dependent on whether or not the move-assign can be trivial.
        template<class... T>
        using VariantMoveAssignBase = abel::conditional_t<
                abel::disjunction<
                        abel::conjunction<abel::is_move_assignable<Union<T...>>,
                                std::is_move_constructible<Union<T...>>,
                                std::is_destructible<Union<T...>>>,
                        abel::negation<abel::conjunction<std::is_move_constructible<T>...,
                                // Note: We're not qualifying this with
                                // abel:: because it doesn't compile
                                // under MSVC.
...
// Base that is dependent on whether or not the copy-assign can be trivial.
        template<class... T>
        using VariantCopyAssignBase = abel::conditional_t<
                abel::disjunction<
                        abel::conjunction<abel::is_copy_assignable<Union<T...>>,
        ...
        protected:
            ...
            struct Destroyer {
                ...
                void operator()(SizeT<I> i) const {
                    using Alternative =
                    typename abel::variant_alternative<I, variant<T...>>::type;
                    variant_internal::AccessUnion(self->state_, i).~Alternative();
                }

                void operator()(SizeT<abel::variant_npos> /*i*/) const {
                    // This space intentionally left blank
                }
        ...
        protected:
            ...
            struct Construct {
                ...
                void operator()(SizeT<I> i) const {
                    ...
                    ::new(static_cast<void *>(&self->state_)) Alternative(
                            variant_internal::AccessUnion(abel::move(other->state_), i));
                }
            ...
            abel::conjunction<std::is_nothrow_move_constructible<T>...>::value)
        ...
        protected:
            ...
            abel::conjunction<std::is_nothrow_move_constructible<T>...,
...
////////////////////////////////////////
        ...
        struct EqualsOp {
            ...
            constexpr bool operator()(SizeT<abel::variant_npos> /*v_i*/) const {
                return true;
            }
...
// TODO(calabrese) do this from a different namespace for proper adl usage
        ...
        struct Swap {
            ...
            void operator()(SizeT<abel::variant_npos> /*w_i*/) const {
...
#endif  // ABEL_ASL_INTERNAL_VARIANT_H_
