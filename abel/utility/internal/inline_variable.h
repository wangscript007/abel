...
#ifndef ABEL_ASL_INTERNAL_INLINE_VARIABLE_EMULATION_H_
#define ABEL_ASL_INTERNAL_INLINE_VARIABLE_EMULATION_H_
...
#endif  // ABEL_ASL_INTERNAL_INLINE_VARIABLE_EMULATION_H_
