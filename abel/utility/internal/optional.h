//
#ifndef ABEL_ASL_INTERNAL_OPTIONAL_H_
#define ABEL_ASL_INTERNAL_OPTIONAL_H_
...
#define ABEL_OPTIONAL_USE_INHERITING_CONSTRUCTORS 1
#endif
...
// This is the specialization for non trivially destructible type.
        ...
        protected:
            ...
            constexpr explicit optional_data_dtor_base(in_place_t, Args &&... args)
                    : engaged_(true), data_(abel::forward<Args>(args)...) {}
...
#ifdef ABEL_OPTIONAL_USE_INHERITING_CONSTRUCTORS
            using base::base;
#else
...
// TODO(abel-team): Add another class using
...
// supported now, so we use is_trivially_* traits instead.
        template<typename T,
                bool unused = abel::is_trivially_copy_constructible<T>::value &&
                              abel::is_trivially_copy_assignable<typename std::remove_cv<
...
// Trivially copyable types
        ...
        protected:
            ...
            constexpr explicit optional_data(in_place_t t, Args&&... args)
                : optional_data_base<T>(t, abel::forward<Args>(args)...) {}
#endif
        };
...
// Copyable implies movable.
        enum class copy_traits {
            copyable = 0, movable = 1, non_movable = 2
        };
...
// Base class for enabling/disabling copy/move assignment.
        ...
        struct assign_copy_traits {
            static constexpr copy_traits traits =
                    abel::is_copy_assignable<T>::value && std::is_copy_constructible<T>::value
                    ? copy_traits::copyable
                    : abel::is_move_assignable<T>::value &&
...
// Base class for std::hash<abel::optional<T>>:
...
// Reference N4659 23.14.15 [unord.hash].
        ...
        template<typename T>
        struct optional_hash_base<T, decltype(std::hash<abel::remove_const_t<T> >()(
                std::declval<abel::remove_const_t<T> >()))> {
            using argument_type = abel::optional<T>;
...
#endif  // ABEL_ASL_INTERNAL_OPTIONAL_H_
