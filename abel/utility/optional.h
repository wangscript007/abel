...
// -----------------------------------------------------------------------------
//
// This header file defines the `abel::optional` type for holding a value which
...
//
//   // Providing an abel::optional return type provides a cleaner API:
//   abel::optional<Resource> AcquireResource(const Input&);
//
// `abel::optional` is a C++11 compatible version of the C++17 `std::optional`
// abstraction and is designed to be a drop-in replacement for code compliant
// with C++17.
#ifndef ABEL_ASL_OPTIONAL_H_
#define ABEL_ASL_OPTIONAL_H_

#include <abel/base/profile.h>   // TODO(calabrese) IWYU removal?
...
#include <abel/utility/bad_optional_access.h>
#include <abel/utility/internal/optional.h>
...
// -----------------------------------------------------------------------------
//
// A value of type `abel::optional<T>` holds either a value of `T` or an
...
// `abel::optional` can also be explicitly instantiated with
// `make_optional<T>(v)`.
//
...
#undef ABEL_MSVC_CONSTEXPR_BUG_IN_UNION_LIKE_CLASS

#endif  // ABEL_USES_STD_OPTIONAL

#endif  // ABEL_ASL_OPTIONAL_H_
