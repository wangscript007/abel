...
#ifndef ABEL_ASL_UTILITY_H_
#define ABEL_ASL_UTILITY_H_
...
// working with C++11 variadic templates). `abel::integer_sequence` is designed
...
// pointer. `abel::apply` is designed to be a drop-in replacement for C++17's
...
//       abel::apply(&user_function1, tuple1);
//
//       std::tuple<std::unique_ptr<Foo>> tuple2(abel::make_unique<Foo>());
//       // Invokes the user function that takes ownership of the unique
//       // pointer.
//       abel::apply(&user_function2, std::move(tuple2));
//
//       auto foo = abel::make_unique<Foo>();
//       std::tuple<Foo*, int> tuple3(foo.get(), 42);
//       // Invokes the method Bar on foo with one argument, 42.
//       abel::apply(&Foo::Bar, tuple3);
//
...
// `obj`.  `abel::exchange` is designed to be a drop-in replacement for C++14's
// `std::exchange`.
//
// Example:
//
//   Foo& operator=(Foo&& other) {
//     ptr1_ = abel::exchange(other.ptr1_, nullptr);
